...
const LogoScroller = () => {
  ...
  return (
    <section className="relative overflow-hidden py-2 bg-white">
          ...
          {doubledRow1.map((company, index) => (
            ...
            >
              <div className="relative p-4 rounded-lg border border-white/10 hover:border-[#D4AF37] transition-all duration-300 group-hover:shadow-lg">
                <span className="text-black text-xl tracking-[4px] font-light hover:text-[#D4AF37] transition-all duration-300 group-hover:scale-105">
                  {company}
                </span>
      ...
      <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-white to-transparent z-30" />
    </section>
  );
};
