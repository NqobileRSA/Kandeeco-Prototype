        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/70 mb-6 leading-relaxed font-avenir">
              ...
              photography, David founded Kandee.co with a vision to elevate
              visual storytelling in South Africa. His work has been featured in
              leading publications across the continent and has earned numerous
              awards for innovation in visual communication.
            </p>

            <p className="text-white/70 mb-10 leading-relaxed font-avenir">
              David&apos;s approach combines technical precision with an
              artistic sensitivity that reveals the authentic essence of each
              subject. His leadership has shaped our studio&apos;s reputation
              for excellence and fostered a collaborative environment where
              creativity thrives.
            </p>
